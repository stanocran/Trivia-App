...
def create_app(test_config=None):
    ...
    def after_request(response):
        response.headers.add("Access-Control-Allow-Methods", "Content-Type, Authorization, true")
    ...
    def questions_in_category(id):
        ...
        if category:
            ...
            formatted_questions = paginate_questions(request, questionsInCat)
